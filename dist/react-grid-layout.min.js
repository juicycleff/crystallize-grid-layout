        ...
        return (
          ...
          (e.prototype.onResize = function(t, e, n, o) {
            var a = o.e,
              ...
              c = s.oldResizeItem,
              p = this.props,
              f = (p.cols, p.preventCollision),
              h = (0, u.getLayoutItem)(l, t);
            if (h) {
              var d = void 0;
              if (f) {
                var y = (0, u.getAllCollisions)(
                  l,
                  r({}, h, { w: e, h: n })
                ).filter(function(t) {
                  return t.i !== h.i;
                ...
                if ((d = y.length > 0)) {
                  ...
                  y.forEach(function(t) {
                    t.x > h.x && (g = Math.min(g, t.x)),
                      t.y > h.y && (m = Math.min(m, t.y));
                  }),
                    Number.isFinite(g) && (h.w = g - h.x),
                    Number.isFinite(m) && (h.h = m - h.y);
                }
              }
              d || ((h.w = e), (h.h = n));
              var v = { w: h.w, h: h.h, x: h.x, y: h.y, static: !0, i: t };
              this.props.onResize(l, c, h, v, a, i);
            }
          }),
          (e.prototype.onResizeStop = function(t, e, n, r) {
            ...
            this.fetchAllItemsUnderPlaceholder(l, p),
                  ...
                  if (t) {
                    ...
                    Date.now(),
                      setTimeout(function() {
                        ...
                        n === e ? f(s, t.getBoundingClientRect()) : (e = n);
                      }, 100);
                  }
                },
                style: r(
