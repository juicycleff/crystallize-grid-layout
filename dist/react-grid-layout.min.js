  ...
  return (function(t) {
    ...
    function(t, e, n) {
      (function(t, n) {
          ...
          return (
            ...
            (null == t || null == e || (!Jt(t) && !Jt(e))
              ...
              : (function(t, e, n, r, o, s) {
                  ...
                  if (!(n & a)) {
                    var D = w && K.call(t, "__wrapped__"),
                      k = R && K.call(e, "__wrapped__");
                    if (D || k) {
                      var E = D ? t.value() : t,
                        P = k ? e.value() : e;
                      return s || (s = new zt()), o(E, P, n, r, s);
                    }
                  }
                  if (!C) return !1;
                  return (
        ...
        function Tt(t) {
          return (
            !(!$t(t) || ((e = t), Q && Q in e)) && (Gt(t) ? tt : C).test(qt(t))
          );
          var e;
        }
        function Mt(t) {
        ...
        function Qt(t) {
          return null != (e = t) && Vt(e.length) && !Gt(e) ? Ct(t) : Mt(t);
          var e;
        }
      ...
      var f = (function(t) {
        function e(n, r) {
          ...
          return (
            ...
            (o.setChildrenPosition = o.setChildrenPosition.bind(o)),
            o
          );
        }
        return (
          ...
          (e.prototype.setChildrenPosition = function(t, e) {
            this.childrenPostion.set(t, e);
          }),
          ...
          (e.prototype.onResize = function(t, e, n, o) {
            var a = o.e,
              ...
              l = s.layout,
              c = s.oldResizeItem,
              f = this.props.preventCollision,
              p = (0, u.getLayoutItem)(l, t);
            if (p) {
              var h = void 0;
              if (f) {
                var d = (0, u.getAllCollisions)(
                  l,
                  r({}, p, { w: e, h: n })
                ).filter(function(t) {
                  return t.i !== p.i;
                ...
                if ((h = d.length > 0)) {
                  ...
                  d.forEach(function(t) {
                    t.x > p.x && (y = Math.min(y, t.x)),
                      t.y > p.y && (g = Math.min(g, t.y));
                  }),
                    Number.isFinite(y) && (p.w = y - p.x),
                    Number.isFinite(g) && (p.h = g - p.y);
                }
              }
              h || ((p.w = e), (p.h = n));
              var m = { w: p.w, h: p.h, x: p.x, y: p.y, static: !0, i: t };
              this.props.onResize(l, c, p, m, a, i);
            }
          }),
          (e.prototype.onResizeStop = function(t, e, n, r) {
            ...
            this.fetchAllItemsUnderPlaceholder(l, f),
          ...
          (e.prototype.fetchAllItemsUnderPlaceholder = function(t, e) {
            var n = this.props.onCollide,
              r = this.childrenPostion.get(e.i);
            if (r && (r.left || r.width || r.Y || r.height)) {
              for (
                var o = r.left + r.width + 10,
                  a = r.y + r.height + 10,
                  i = [],
                  s = 0;
                s < this.props.layout.length;
                s++
              ) {
                var u = this.props.layout[s];
                if (t.i && u.i && t.i !== u.i) {
                  var l = this.childrenPostion.get(u.i);
                  if (!l) continue;
                  var c = l.x + l.width,
                    f = l.y + l.height;
                  c >= r.x && c <= o && f >= r.y && f <= a && i.push(u);
                }
              }
              n({ item: e, elements: i });
            }
          ...
          (e.prototype.placeholder = function() {
            ...
            return o.default.createElement(
              l.default,
              {
                ...
                isResizable: !1,
                useCSSTransforms: c,
                setChildrenPosition: function(t, e) {
...
*/
	...
	*/
        ...
        var D = (function() {
            ...
            if (t in e) return "";
            for (var n = 0; n < z.length; n++) if (C(t, z[n]) in e) return z[n];
            return "";
          })(),
          k = function(t, e) {
            if (!(t instanceof e))
                ...
                value: function() {
                  ...
                  var f = this.props,
                    ...
                    g = x(
                      y.props.className || "",
                      p,
                      (P((t = {}), h, this.state.dragging),
                      P(t, d, this.state.dragged),
                      t)
                    );
        ...
        return (
          ...
          (e.prototype.render = function() {
            var t = this.props,
              ...
              p = t.setChildrenPosition,
              h = this.calcPosition(e, n, a, i, this.state),
              ...
              y = o.default.cloneElement(d, {
                ...
                ref: function(t) {
                  if (t) {
                    var e = JSON.stringify(t.getBoundingClientRect());
                    setTimeout(function() {
                      var n = JSON.stringify(t.getBoundingClientRect());
                      n === e ? p(s, t.getBoundingClientRect()) : (e = n);
                    }, 100);
                  }
                },
                style: r(
            ...
            return (
              c && (y = this.mixinResizable(y, h)),
              u && (y = this.mixinDraggable(y)),
              y
            );
          }),
          e
